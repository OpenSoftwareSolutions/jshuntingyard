...
public class Length extends AbstractOneArgFunctionElement<Integer,String> {
	...
	@Override
	protected FunctionElementArgument<Integer> execute(FunctionElementArgument<String> a) throws IllegalArgumentException {
