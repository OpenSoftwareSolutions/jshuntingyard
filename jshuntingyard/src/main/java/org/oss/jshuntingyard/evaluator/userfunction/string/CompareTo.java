 ...
 *
 */
public class CompareTo extends AbstractTwoArgFunctionElement<Boolean,String,String> {

	public CompareTo() {
		super("compareTo", Precedence.USERFUNCTION);
	...
	protected FunctionElementArgument<Boolean> execute(FunctionElementArgument<String> a,FunctionElementArgument<String> b) throws IllegalArgumentException {
		return FunctionArgumentFactory.createBoolean(a.getValue().compareTo(b.getValue()));
	}
}