 ...
 */
public class Sin extends AbstractNumericOperatorAssociativityLeftOneArg {

	public Sin() {
		super("sin", Precedence.USERFUNCTION);
	}
	...
	public FunctionArgument<?> execute(FunctionArgument<?> a) throws IllegalArgumentException {
		...
		if (a.getType()==FunctionArgument.ArgumentType.DOUBLE) {
			return FunctionArgumentFactory.createObject(Math.sin(getDouble(a)));
		}
